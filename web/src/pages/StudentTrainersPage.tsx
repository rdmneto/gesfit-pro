import { CheckCircle2, Clock, Pause, Play, Plus, Star, UserX, Zap } from "lucide-react";
      ...
      {loading ? (
        ...
        <div className="mt-6 grid gap-4">
          {visible.map((enrollment) => {
            ...
            const isActive = activeTrainerId === enrollment.trainerId;
              ...
              >
                ...
                {enrollment.status === "pending" && (
                  <p className="mt-3 text-sm text-stone-500">
                    Seu pedido foi enviado. Assim que o treinador aprovar, este vínculo fica ativo e você poderá comprar aulas.
                  </p>
                )}
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {enrollment.status === "active" && !isActive && (
                    <button
                      ...
                      onClick={() => setActiveTrainer(enrollment.trainerId)}
                    >
                  ...
                  {enrollment.status === "active" && (
                    <button
                      ...
                      onClick={() => changeStatus(enrollment, "paused")}
                    >
                  ...
                  {enrollment.status === "paused" && (
                    <button
                      type="button"
                      className="focus-ring btn btn-primary btn-sm"
                      onClick={() => changeStatus(enrollment, "active")}
                    >
                  ...
                  {enrollment.status !== "pending" && (
                    <button
                      ...
                      onClick={() => changeStatus(enrollment, "cancelled")}
                    >
